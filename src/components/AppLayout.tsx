...
export const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  const navigationItems = [
    ...
    { name: "Карта магазинов", path: "/stores", icon: MapPin },
  ];
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-app-background">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 p-4">
        <div className="flex items-center mb-8 mt-2">
          ...
          <h1 className="ml-3 text-xl font-semibold">Т. Консультант</h1>
        </div>
      ...
      <header className="md:hidden flex items-center justify-between p-4 bg-white border-b border-gray-200">
        <div className="flex items-center">
          ...
          <h1 className="ml-2 text-lg font-semibold">Т. Консультант</h1>
        </div>
        <div className="flex items-center">
